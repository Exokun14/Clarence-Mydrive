                    ...
                    <div class="container-a">
                        ...
                        <div id="assignment" class="home-tabs">
                            ...
                            <div class="home-tab-content">
                                ...
                                <p>You can access your assignments here.</p>

                                <div class="get-started">
                                    <div class="get-started-button">
                                        <a href="Sub-Pages/assignment-user.php" id="get-started-button">PROCEED</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="quiz" class="home-tabs">
                            <div class="home-tab-content">
                                ...
                                <p>You can access your quizzes here.</p>
                        ...
                        <div id="assessment" class="home-tabs">
                            <div class="home-tab-content">
                                ...
                                <p>You can access your assessments here.</p>
                    ...
                    <div class="container-b">
                        ...
                        <div id="exam" class="home-tabs">
                            <div class="home-tab-content">
                                ...
                                <p>You can access your exams here.</p>
                        ...
                        <div id="project" class="home-tabs">
                            <div class="home-tab-content">
                                ...
                                <p>You can access your projects here.</p>
