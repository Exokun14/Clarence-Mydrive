...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container">
            <p onclick="location.href='../home-admin.php'" id="back-button">
            ...
            <div class="tab-content">
                <h3 id="tab-content-header">WELCOME TO PROJECTS TAB</h3>

                <div class='assigned-task-container'>
                    <?php
                        require 'project-admin-display.php';
                    ...
                    <div class='tab-description-actions'>
                        <div class='tab-description-actions-empty'>
                            <a href='upload-project-admin.php' id='mark-as-done'>ADD PROJECT</a>
                        </div>
                    </div>
