...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container-form">
            <p onclick="location.href='assignment-admin.php'" id="back-button-form">
            ...
            <div class="tab-content">
                <h1 id='tab-form-header'>UPLOAD ASSIGNMENTS TAB</h1>

                <div class='form-holder'>
                    <form class='form-content' id="upload-form" name="upload-assigment-form" enctype="multipart/form-data" action="upload.php" method="POST">

                        <div>
                            <label for="assign-no">Assignment No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="assign-no"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <label>Assignment Title: </label>
                            <input id='input-field-small' type="text" placeholder='Input goes here' name="assign-title" maxlength="50" size="50" required/>
                        </div>
                        ...
                        <div>
                            ...
                            <input id='input-field-small' type="file" name="assign-file" id="assign-file" required/>
                        </div>

                        <div>
                            <label for="assign-no">User No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="user-id"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <input id='submit-button-form' type="submit" name="upload-assign" value="Upload"/>
                        </div>
