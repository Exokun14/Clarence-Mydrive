...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container-form">
            <p onclick="location.href='project-admin.php'" id="back-button-form">
            ...
            <div class="tab-content">
                <h1 id='tab-form-header'>UPLOAD PROJECT TAB</h1>

                <div class='form-holder'>
                    <form class='form-content' id="upload-form" name="upload-project-form" enctype="multipart/form-data" action="upload.php" method="POST">

                        <div>
                            <label for="project-no">Project No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="project-no"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <label>Project Title: </label>
                            <input id='input-field-small' type="text" placeholder='Input goes here' name="project-title" maxlength="50" size="50" required/>
                        </div>
                        ...
                        <div>
                            ...
                            <input id='input-field-small' type="file" name="project-file" id="project-file" required/>
                        </div>

                        <div>
                            <label for="project-no">User No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="user-id"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <input id='submit-button-form' type="submit" name="upload-project" value="Upload"/>
                        </div>
