...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container">
            <p onclick="location.href='project-admin.php'" id="back-button">
            ...
            <div class="tab-content">
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) 
                        {
                            ...
                            $sql = "SELECT * FROM `upload_project` WHERE `Uploaded_By` = '". $user . "'";
                            $result = $connection->query($sql);
                            ...
                            <div class='view-tab-container'>
                                ...
                                <div class='attachment-container'>
                                    ...
                                    <div class='attachment-content'>
                                        ...
                                        <a href='../../Uploads/project-uploads-user/" .$content. "' download='" .$content. "'>$content</a>
                                    </div>
                                </div>
