...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container-form">
            <p onclick="location.href='exam-admin.php'" id="back-button-form">
            ...
            <div class="tab-content">
                <h1 id='tab-form-header'>UPLOAD EXAMINATION TAB</h1>

                <div class='form-holder'>
                    <form class='form-content' id="upload-form" name="upload-exam-form" enctype="multipart/form-data" action="upload.php" method="POST">

                        <div>
                            <label for="exam-no">Exam No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="exam-no"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <label>Exam Title: </label>
                            <input id='input-field-small' type="text" placeholder='Input goes here' name="exam-title" maxlength="50" size="50" required/>
                        </div>
                        ...
                        <div>
                            ...
                            <input id='input-field-small' type="file" name="exam-file" id="exam-file" required/>
                        </div>

                        <div>
                            <label for="exam-no">User No. </label>
                            <input id='input-field-small' type="int" placeholder='Input goes here' name="user-id"  maxlength="4" size="4" required/>
                        </div>

                        <div>
                            <input id='submit-button-form' type="submit" name="upload-exam" value="Upload"/>
                        </div>
