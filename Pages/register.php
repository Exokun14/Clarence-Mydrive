    ...
    <body>
        ...
        <div class=register-page-container>
            ...
            <div class="container">
                ...
                <div>
                    <form action="../Backend/Actions/register-backend.php" method="POST">
                        <div class="section-container" id="section-1-container">
                            <div class="section-1">
                                <h1 id="form-header">YOUR JOURNEY STARTS HERE..</h1>
                                <img id="form-image" src="../Pics/Hello_Emote.webp"></img>
                                <h3 id="form-sub-header">Let's start with your email address.</h3>

                                <div class="form-input">
                                    <input class="input-field" type="text" name="user-name" placeholder="Enter email address here.." size="35" required></input>
                                </div>
                        ...
                        <div class="section-container" id="section-2-container">
                            <div class="section-1">
                                <h1 id="form-header">NOW ONTO YOUR PASSWORD</h1>
                                <img id="form-image" src="../Pics/AhriNurse.png"></img>
                                <h3 id="form-sub-header">Try to think of something that is easy to remember.</h3>

                                <div class="form-input">
                                    <input class="input-field" type="password" name="user-password" placeholder="Enter password here.." size="35" required></input>
                                </div>
                            ...
                            <div class="next-buttons">
                                ...
                                <div onclick="submitForm()" id="next-button" class="get-started">
                                    <div class="get-started-button">
                                        <button type="submit" name="register-form-submit" id="get-started-button">SUBMIT</button>
                                    </div>
                                </div>
