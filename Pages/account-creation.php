            ...
            <div class="container-1">
                <div class="reg-header">
                    ...
                    <div class="reg-content">
                        <h4>Sign up to get the following:</h4>
                        <ul>
                            <li>Access to administrator dashboard.</li>
                            <li>Upload assignments to designated people.</li>
                            <li>Be able to grade the works submitted.</li>
                            <li>View, edit and delete current assignments.</li>
                        </ul>
                    </div>

                    <div class="get-started">
                        <div class="get-started-button">
                            <a href="Registration-pages/register-staff.php" id="get-started-button">SIGN UP</a>
                        </div>
                    </div>
                ...
                <div class="reg-header">
                    ...
                    <div class="reg-content">
                        ...
                        <ul>
                            ...
                            <li>Upload and submit files for assigned tasks.</li>
                            <li>Be able to view the grades of work submitted.</li>
                            <li>View, edit and delete current assigned tasks.</li>
                        </ul></br>
                    </div>

                    <div class="get-started">
                        <div class="get-started-button">
                            <a href="register.php" id="get-started-button">SIGN UP</a>
                        </div>
                    </div>
                </div>
