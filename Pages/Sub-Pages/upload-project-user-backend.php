<?php
    ...
    $uploadsDirectory = "../../Uploads/project-uploads-user";
    $counter = 0;
    ...
    while ($counter < $fileCount) 
    {
        ...
        if ($file != null) 
        {
            $sql = "INSERT INTO upload_project(Project_ID, Upload_Category, Upload_Content, Uploaded_By)
            VALUES ('$num', 'Project',  '$file',  '$user')";
    ...
    header("Location: uploaded-project.php");
?>