...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container">
            <p onclick="location.href='exam-user.php'" id="back-button">
            ...
            <div class="tab-content">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `exam` WHERE `Exam_ID` = '". $num . "'";
                        ...
                        echo "
                            <h3 id='tab-content-alt-header'> Exam Title: $title</h3>
                            <div class='view-tab-container'>
                                ...
                                <div class='tab-description-actions'>
                                    <div class='tab-description-actions-empty'>
                                        <a href='upload-exam-user.php' id='add-files'>ADD FILES</a>
