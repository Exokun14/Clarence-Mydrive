<?php
    ...
    $uploadsDirectory = "../../Uploads/exam-uploads-user";
    $counter = 0;
    ...
    while ($counter < $fileCount) 
    {
        ...
        if ($file != null) 
        {
            $sql = "INSERT INTO upload_exam(Exam_ID, Upload_Category, Upload_Content, Uploaded_By)
            VALUES ('$num', 'Examination',  '$file',  '$user')";
    ...
    header("Location: uploaded-exam.php");
?>