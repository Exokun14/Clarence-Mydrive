...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container">
            <p onclick="location.href='assignment-user.php'" id="back-button">
            ...
            <div class="tab-content">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `assignment` WHERE `Assign_ID` = '". $num . "'";
                        ...
                        echo "
                            <h3 id='tab-content-alt-header'> Assignment Title: $title</h3>
                            <div class='view-tab-container'>
                                ...
                                <div class='attachment-container'>
                                    ...
                                    <div class='attachment-content'>
                                        ...
                                        <a href='../../Uploads/assign-uploads-admin/" .$content. "' download='" .$content. "'>$content</a>
                                    </div>
                                </div>

                                <div class='tab-description-actions'>
                                    <div class='tab-description-actions-empty'>
                                        <a href='upload-assignment-user.php' id='add-files'>ADD FILES</a>
