<?php
    ...
    function display() 
    {
        ...
        $sql = "SELECT * FROM `quiz` WHERE `User_ID` = '". $_SESSION["Account_Number"] . "'";
                    ...
                    <div class='tab-content-entry'>
                        <div>
                            <div class='tab-content-title' id='name'>
                                ...
                                <form action='view-quiz-user.php' method='POST'>
        ...
        else 
        {
            echo "
                <div class='no-work-container'>
                    ...
                    <p>Quizzes will show up here when assigned! Worry not, you feeder yasuo mid main!</p>
                </div>
            ";
        }
    }
