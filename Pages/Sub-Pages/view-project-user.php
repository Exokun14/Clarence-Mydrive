...
<html>
    ...
    <body>
        ...
        <div class="tab-content-container">
            <p onclick="location.href='project-user.php'" id="back-button">
            ...
            <div class="tab-content">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM `project` WHERE `Project_ID` = '". $num . "'";
                        ...
                        echo "
                            <h3 id='tab-content-alt-header'> Project Title: $title</h3>
                            <div class='view-tab-container'>
                                ...
                                <div class='tab-description-actions'>
                                    <div class='tab-description-actions-empty'>
                                        <a href='upload-project-user.php' id='add-files'>ADD FILES</a>
