<html>
    ...
    <link rel="stylesheet" href="../../Styles/register-staff-backend.css">
    ...
    <body>
            ...
            <?php
                ...
                if (isset($_POST['register-staff-form-submit']))
                {
                    register();
                }
                ...
                function register() 
                {
                    ...
                    {
                        $sql = "INSERT INTO admin_account(Email, Password, First_Name, Last_Name, Middle_Name, Position) 
                        VALUES ('$userName', '$userPassword', '$Fname', '$Lname', '$Mname', '$position')";
